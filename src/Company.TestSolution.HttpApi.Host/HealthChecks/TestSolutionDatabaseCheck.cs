...
public class TestSolutionDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public TestSolutionDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
